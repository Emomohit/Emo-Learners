...
export const Route = createFileRoute("/privacy-policy")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "How EMO Learners collects, uses, and protects your personal data.",
      },
      ...
      <section className="relative px-4 pb-24 pt-16">
        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          <div className="mt-10 space-y-8 text-[15px] leading-relaxed text-muted-foreground">
            <p>
              Welcome to EMO Learners. We respect your privacy and are committed to protecting your
            ...
            <div>
              ...
              <ul className="mt-3 list-disc space-y-2 pl-5">
                <li>
                  <span className="text-foreground font-semibold">Identity Data</span> — first name,
                  last name, username or similar identifier.
                </li>
                <li>
                  <span className="text-foreground font-semibold">Contact Data</span> — email
                  address and telephone numbers.
                </li>
                <li>
                  <span className="text-foreground font-semibold">Technical Data</span> — IP
                  address, browser type and version, time zone, OS and platform.
                </li>
              </ul>
            </div>
