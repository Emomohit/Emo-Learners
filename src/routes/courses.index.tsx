          ...
          {courses.map((c, i) => {
            ...
            return (
              <Link
                key={c.slug}
                to={href}
                className="group relative flex flex-col overflow-hidden panel p-6 transition-all duration-300 panel-hover/60 hover:bg-surface hover:shadow-brand animate-rise"
