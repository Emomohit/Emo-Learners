  ...
  return (
    <section className="mx-auto max-w-5xl px-4 py-14">
      ...
      <p className="mt-3 max-w-2xl text-muted-foreground">
        Top patterns asked in Indian tech placements — TCS, Infosys, Wipro, Cognizant to Amazon,
        Microsoft, Google. Ranked by real interview frequency.
      </p>

      <div className="mt-4 flex flex-wrap gap-3 text-xs text-muted-foreground">
        <span>Also see:</span>
        <Link to="/practice" className="text-primary underline">
          General practice
        </Link>
        <Link to="/challenge" className="text-primary underline">
            ...
            {problems.map((p, i) => (
              ...
              >
                ...
                <td className="px-4 py-3">
                  <span
                    className={`rounded-full border px-2 py-0.5 font-mono text-[10px] uppercase tracking-widest ${diffColor[p.difficulty]}`}
                  >
                    {p.difficulty}
                  </span>
                </td>
                ...
                <td className="px-4 py-3 text-right">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1 rounded-full border border-border px-3 py-1 font-mono text-[10px] uppercase tracking-widest text-primary hover:border-primary"
                  >
