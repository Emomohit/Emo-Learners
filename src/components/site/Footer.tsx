      ...
      <div className="mx-auto grid w-full max-w-7xl gap-12 px-6 py-16 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-5 max-w-md text-sm leading-relaxed text-muted-foreground">
            A free playground for ambitious Indian students. AI tools, curated resources, quizzes,
            tests, and real internships — built so you can stop wasting time and start building.
          </p>
        ...
        <div>
          <h4 className="font-mono text-[11px] font-bold uppercase tracking-[0.25em] text-primary">
            Explore
          </h4>
          <ul className="mt-4 space-y-2.5 text-sm text-muted-foreground">
            <li>
              <Link to="/emoiq" className="transition-colors hover:text-foreground">
                EMoIQ (AI Exam Engine)
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/tests" className="transition-colors hover:text-foreground">
                Tests
              </Link>
            </li>
            <li>
      ...
      <div className="border-t border-border">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-6 py-6 text-xs text-muted-foreground md:flex-row">
          <p className="font-mono uppercase tracking-widest">
            © {new Date().getFullYear()} EMO Learners — Built for students, by students. 🇮🇳
          </p>
